...
const Home = () => {
  return (
    <>
      {/* Hero section */}
      <section className="relative w-full h-[45rem] font-general-sans">
        {/* Background Image */}
        <img
          src="/background.svg"
        ...
        {/* Overlay / Content */}
        <div className="absolute inset-0 wrapper md:mt-20">
          <section className="mt-20">
            ...
            <div className="bg-primary/20 backdrop-blur-md rounded-full lg:px-5 lg:py-2.5 xs:px-5 xs:py-3 flex items-center gap-2 w-fit mb-4">
              <BsStars className="text-primary" aria-label="Stars Icon" />
            ...
            <p className="mt-4 text-[1.1rem] lg:text-[1.25rem] font-normal text-neutral/80 max-w-2xl leading-relaxed">
              Get easy access to market insights that help you understand
              trends, make better decisions, and stay ahead. Start with free
              insights and unlock detailed research when you need it.
            </p>
      ...
      <main className="wrapper">
        <section className="font-general-sans overflow-hidden bg-white">
          {/* heading intro */}
          <section>
            ...
            <div className="mt-20">
              ...
              <p className="lg:text-xl">
                We provide easy-to-understand market insights and researched
                data to help you make smarter, more reliable decisions. Today,
                we focus on trekking and tourism trends, and in the future,
                we’ll expand into new industries and emerging fields like AI
                research. Our goal is to give you the information you need —
          ...
          <section className="my-32" aria-labelledby="smart-solutions">
            <h1 className="h1" role="heading" aria-level="2">
                ...
                >
                  ...
                  <div className="w-full absolute inset-0 flex flex-col justify-between p-5 z-10 bg-gradient-to-b  from-[var(--color-primary)]/30 to-blue-500/10 h-full ">
                    <div className="flex flex-col gap-4 ">
                      <div
                        className="bg-white/30 border border-primary p-3 w-12 h-12  rounded-md flex justify-center items-center"
                        aria-label="Market Solutions Icon"
                      >
                        {card.icon}
                      </div>
                      <div className="w-full">
                        <h1 className="xs:text-xl lg:text-3xl font-medium lg:w-[18rem] ">
                          {card.title}
                        </h1>
                        <p className="xs:text-[1rem] lg:text-[1rem] mt-5    xs:leading-6 ">
                          {card.description}
                        </p>
                      </div>
                    </div>
          ...
          <section className="my-32 min-h-[28rem] ">
            <h1 className="h1 mb-8">Latest Market Intelligence Blogs</h1>
              ...
              {blog.map((item, index) => (
                ...
                >
                  ...
                  <div className="p-3 flex flex-col flex-1">
                    {/* 2. Title */}
                    <h3
                      className="xs:text-xl lg:text-2xl font-medium text-slate-900 mb-3"
                      role="heading"
                      aria-level="3"
                    >
                      {item.title}
                    ...
                    <div className="mt-auto flex items-center justify-between pt-4">
                      ...
                      <button className="flex items-center py-2 px-2 lg:px-4 gap-3 rounded-full bg-primary text-sm hover:bg-blue-800 transition-all duration-300 shadow-sm">
                        <p className="text-white lg:block xs:hidden">
                          Read More
                        </p>
          ...
          {/* ======== Market Intelligence Blogs section ends ======== */}
          ...
          <div className="w-full overflow-hidden mt-20 mb-32 bg-primary px-6 py-10 text-white rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-10 md:gap-14">
            ...
            <div className="sm:w-1/2 flex flex-col gap-4 text-center sm:text-left">
              ...
              <p className="text-sm md:text-base hidden xs:block">
                Don’t miss the latest in market intelligence. Subscribe to our
                blog for updates, expert insights, and key trends to stay ahead.
              </p>
            </div>
